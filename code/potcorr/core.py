"""Core reciprocal-space engine: descreening and 3D-periodic rescreening.

Implements the potential-space route of Eqs. (11)-(13) of
R. Guo et al., Phys. Rev. Lett. 135, 126302 (2025):

    descreen    rho_tot -> V_H,WJ -> V_bare -> rho_bare      Eq. (11)/(12)
    rescreen    rho_bare -> V_H^{ns->cs}  with W = v eps^-1  Eq. (5)/(6)/(13)

All quantities are in Rydberg atomic units (energies in Ry, lengths in Bohr).
"""
