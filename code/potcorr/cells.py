"""Cell definitions: lattice, supercell size, FFT grid and data paths.

Each entry is a dict consumed by `PotCorr.__init__`. Paths point at the
author's Anvil scratch tree; edit `folder` for your own data.
"""
